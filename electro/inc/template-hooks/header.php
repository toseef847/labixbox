...
add_action( 'electro_before_header_v10',    'electro_top_bar_v4',         10 );

add_action( 'electro_before_header_v11',    'electro_top_bar_v5',         10 );
...
require_once get_template_directory() . '/inc/template-hooks/header-v10.php';
require_once get_template_directory() . '/inc/template-hooks/header-v11.php';
