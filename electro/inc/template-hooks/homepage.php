...
add_action( 'homepage_v10', 'electro_home_v10_page_template_content',                          5 );
add_action( 'homepage_v10', 'electro_home_v10_slider_with_ads_block',                          10 );
add_action( 'homepage_v10', 'electro_home_v10_sidebar_with_products',                          20 );

add_action( 'homepage_v11', 'electro_page_template_content',                                    5 );
add_action( 'homepage_v11', 'electro_home_v11_slider_block',                                    10 );
add_action( 'homepage_v11', 'electro_home_v11_brands_with_category_block',                       20 );
add_action( 'homepage_v11', 'electro_home_v11_banner_with_products_carousel',                   30 );
add_action( 'homepage_v11', 'electro_home_v11_banners_block',                                   40 );
add_action( 'homepage_v11', 'electro_home_v11_products_carousel',                               50 );
add_action( 'homepage_v11', 'electro_home_v11_trending_products_carousel',                      60 );
...
add_action( 'electro_before_homepage_v10', 'electro_home_v10_hook_control',                   10 );
add_action( 'electro_before_homepage_v11', 'electro_home_v11_hook_control',                   10 );
