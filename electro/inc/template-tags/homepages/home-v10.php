...
if ( ! function_exists( 'electro_home_v10_slider_block' ) ) {
	function electro_home_v10_slider_block() {
...
if ( ! function_exists( 'electro_home_v10_ads_block' ) ) {
	 ...
	 */
	function electro_home_v10_ads_block() {
...
if ( ! function_exists( 'electro_home_v10_sidebar_with_products' ) ) {
	function electro_home_v10_sidebar_with_products() {
		...
		?><div <?php echo electro_render_attributes( $attr ); ?>>
			<?php if ( $is_sidebar_enabled && ( has_nav_menu( 'all-departments-menu' ) || is_active_sidebar( 'home-v10-sidebar-widgets' ) ) ) : ?>
							...
							<div class="departments-menu-v2">
								<div class="dropdown show-dropdown">
									<div class="departments-menu-v2-title">
										<?php if ( $swpb_options[ 'sidebar_menu_title' ] ) : ?>
											<section class="w-100 mb-0">
												<header class="mb-0">
													<h2 class="h1 fw-bold"><?php echo esc_html( $swpb_options[ 'sidebar_menu_title' ] ); ?></h2>
												</header>
											</section>
										<?php endif; ?>
									</div>
